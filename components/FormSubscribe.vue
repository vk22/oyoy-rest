<template>
  <div class="subscribe-form">
    ...
    <Form ref="form" @submit="onSubmit" :validation-schema="schema" @invalid-submit="onInvalidSubmit"
      class="subscribe-form__container">
...
const storeSubscribers = useSubscribersStore();
const props = defineProps(["mode", "title"]);

const time = ref();
const title = 'Get the Newsletter';
const subtitle = 'Join the OyOy newsletter to stay ahead of our news.';
...
async function onSubmit(values, { resetForm }) {
  ...
  response.value = await storeSubscribers.postData(values)
  resetForm();
  setTimeout(() => {
    response.value = null;
  }, 3000);
