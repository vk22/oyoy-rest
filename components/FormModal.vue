<template>
      <div class="form-modal modal-window" v-show="formModalOpened">  
        <div class="close" @click="formModalStateToggle()">
...
let formModalOpened =  computed(() => store.getFormModalState)
